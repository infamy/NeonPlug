...
export const D890_MEMORY_MAP: readonly D890Region[] = [
  { name: 'Local info', address: D890_ADDR.LOCAL_INFO, size: D890_ADDR.LOCAL_INFO_SIZE,
    contents: 'Firmware / region identity', read: true, provenance: 'hardware', note: 'NEVER WRITE. Device information block, and the read-length negotiation probe target.' },
  ...
  { name: 'Unclaimed mask', address: D890_ADDR.RADIO_ID_SET, size: D890_ADDR.RADIO_ID_SET_SIZE,
    contents: 'Read here as the radio-ID occupancy mask', read: true, write: true, provenance: 'inferred',
  ...
  { name: 'Scan-list mask', address: D890_ADDR.SCAN_LIST_SET, size: D890_ADDR.SCAN_LIST_SET_SIZE,
    contents: 'One bit per scan list; SET = present', read: true, write: true, provenance: 'hardware' },
  ...
  { name: 'Zone names', address: D890_ADDR.ZONE_NAMES, stride: D890_ADDR.ZONE_NAME_STRIDE,
    contents: '17 UTF-16LE units, 0xffff-terminated', read: true, write: true, provenance: 'hardware' },
  { name: 'Radio (DMR) IDs', address: D890_ADDR.RADIO_ID_DATA, stride: D890_ADDR.RADIO_ID_STRIDE,
    contents: 'BCD-as-hex ID at +0x00, UTF-16LE name at +0x04', read: true, write: true, provenance: 'hardware' },
  ...
  { name: 'RX group lists', address: D890_ADDR.RX_GROUP_DATA, stride: D890_ADDR.RX_GROUP_STRIDE,
    contents: 'u32 members from +0x00, name at +0x100', read: true, write: true, provenance: 'hardware' },
  { name: 'Unidentified table below the talkgroup mask', address: 0x3900000, size: 40000,
    contents: '10,000 u32 slots; the used ones count up from 0', read: true, provenance: 'inferred',
  ...
  { name: 'Talkgroup mask', address: D890_ADDR.TALKGROUP_SET, size: D890_ADDR.TALKGROUP_SET_SIZE,
    contents: 'INVERTED — a set bit means the slot is EMPTY', read: true, write: true, provenance: 'hardware',
  ...
  { name: 'MDC1200', address: 0x3702000, stride: 0x40, size: 0x40 * 100,
    contents: 'MDC1200 encode and decode lists', read: false, provenance: 'hardware',
