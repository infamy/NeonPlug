...
export const D890_MEMORY_MAP: readonly D890Region[] = [
  ...
  { name: 'Unidentified table below the talkgroup mask', address: 0x3900000, size: 40000,
    contents: '10,000 u32 slots; the used ones count up from 0', read: true, write: true, provenance: 'inferred',
  ...
  { name: 'SMS-associated block', address: 0x2980000, size: 0x640,
    ...
    read: true, write: true, provenance: 'unknown',
  ...
  { name: 'Analog address book masks', address: 0x3800000, size: 0x180,
    contents: 'Presence masks for the analog address book', read: true, write: true, provenance: 'marshaller' },
  ...
  { name: 'Hot key / one-key', address: 0x3700000, size: 0x1530,
    contents: 'One-key assignments', read: true, write: true, provenance: 'marshaller' },
