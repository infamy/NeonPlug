  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'measurePeriodInterval', label: 'Measure Period Interval', type: 'number', min: 5, max: 255 },
      ],
    },
    {
      id: 'alertTones',
    ...
    },
    {
      ...
      fields: [
        {
          key: 'workModeFlags',
          label: 'Work Mode Flags',
          type: 'bitfield',
          bits: [
            { bitIndex: 0, label: 'Only Channel Mode' },
            { bitIndex: 1, label: 'Distance Unit' },
            { bitIndex: 2, label: 'GPS Mode' },
            { bitIndex: 3, label: 'Speed Unit' },
            { bitIndex: 4, label: 'GPS Display Format' },
          ],
        },
      ],
    },
    {
      ...
      title: 'GPS / Digital',
      fields: [
        { key: 'gpsAprsFlags', label: 'GPS APRS (bit 0)', type: 'bitfield', bits: [{ bitIndex: 0, label: 'GPS Enable' }] },
        { key: 'callHoldTime', label: 'Call Hold Time', type: 'number', min: 0, max: 61 },
        { key: 'remoteMonitorTime', label: 'Remote Monitor Time', type: 'number', min: 0, max: 255 },
        { key: 'activeWaitTime', label: 'Active Wait Time', type: 'number', min: 1, max: 255 },
        { key: 'activeRetriesTime', label: 'Active Retries Time', type: 'number', min: 1, max: 255 },
        { key: 'preCarrierTime', label: 'Pre Carrier Time', type: 'number', min: 0, max: 255 },
      ...
      fields: [
        {
          ...
          type: 'bitfield',
          bits: [
            { bitIndex: 0, label: 'Radio Disable Decode' },
            { bitIndex: 1, label: 'Remote Monitor Decode' },
            { bitIndex: 2, label: 'Radio Enable Decode' },
            { bitIndex: 3, label: 'Radio Disable Decode' },
          ],
        },
        {
          key: 'digitalSettingsCont',
          label: 'Digital Settings (cont)',
          type: 'bitfield',
          bits: [
            { bitIndex: 0, label: 'Digital Setting 0' },
            { bitIndex: 1, label: 'Digital Setting 1' },
            { bitIndex: 2, label: 'Digital Setting 2' },
          ],
        },
      ],
    },
